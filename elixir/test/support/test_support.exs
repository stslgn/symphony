...
defmodule SymphonyElixir.TestSupport do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      setup do
        ...
        run_ledger_path = Path.join(workflow_root, "run-ledger.jsonl")
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          workspace_durability_remote_url: nil,
          workspace_preserve_terminal_parked_issue_ids: [],
          worker_ssh_hosts: [],
    ...
    workspace_durability_remote_url = Keyword.get(config, :workspace_durability_remote_url)

    workspace_preserve_terminal_parked_issue_ids =
      Keyword.get(config, :workspace_preserve_terminal_parked_issue_ids)
    ...
    codex_mcp_elicitation_auto_approve_allowlist =
      Keyword.get(config, :codex_mcp_elicitation_auto_approve_allowlist)
    ...
    sections =
      [
        ...
        "  durability_remote_url: #{yaml_value(workspace_durability_remote_url)}",
        "  preserve_terminal_parked_issue_ids: #{yaml_value(workspace_preserve_terminal_parked_issue_ids)}",
