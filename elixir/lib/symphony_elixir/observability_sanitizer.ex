defmodule SymphonyElixir.ObservabilitySanitizer do
  ...
  @retry_error_codes ~w(agent_exit worker_stalled spawn_failed retry_poll_failed capacity_unavailable worker_failure workspace_cleanup_pending workspace_cleanup_failed workspace_affinity_missing workspace_preservation_required)
